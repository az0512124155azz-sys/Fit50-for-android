...
`full-body.mjs` authors coordinated trajectories for 31 exercises, including
...
Motion tests load the actual GLB, sample all 31 cycles at 60 Hz, verify reachable
