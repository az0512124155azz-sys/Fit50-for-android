(function(){
  ...
  const EN = {
    ...
    'כל הסיבות שדורשות בירור:':'All answers that need clarification:',
    'השלם את שאלות הבטיחות החדשות':'Complete the new safety questions',
    'מה מצב הכאב בחזה כיום?':'What is the current status of the chest pain?',
    'האם אתה חש כאב בחזה בזמן מנוחה או במהלך פעולות יומיומיות?':'Do you have chest pain at rest or during everyday activities?',
    'האם בשנה האחרונה איבדת שיווי משקל בגלל סחרחורת, שלא נבעה מנשימת יתר?':'In the past year, have you lost your balance because of dizziness unrelated to over-breathing?',
    'האם איבדת הכרה בשנה האחרונה?':'Have you fainted in the past year?',
    'אם אובחנה אצלך אסתמה: האם נזקקת לטיפול תרופתי בשלושת החודשים האחרונים?':'If you have asthma, have you needed medication for it in the past three months?',
    'האם בשלושת החודשים האחרונים חווית קוצר נשימה או צפצופים?':'Have you had shortness of breath or wheezing in the past three months?',
    'אם סימנת סחרחורת, אובדן הכרה או תסמיני אסתמה: האם האירוע נבדק ואיש מקצוע רפואי אישר לך פעילות גופנית?':'If you reported dizziness, fainting, or asthma symptoms, were they evaluated and were you cleared for exercise?',
    'לא או לא בטוח':'No or not sure',
    'הכאב חדש, חוזר, או שטרם נבדק':'The pain is new, recurring, or has not been evaluated',
    'הכאב חלף, נבדק, וקיבלתי אישור והנחיות לפעילות':'The pain has resolved, was evaluated, and I received approval and activity guidance',
    'מלא שאלון מחדש בלי התשובות הקודמות':'Start the questionnaire again without previous answers',
    'סמן כל מה שרלוונטי. התשובות נשמרות גם בחשבון שלך כדי להתאים אימונים.':'Select all that apply. Your answers are also saved to your account to tailor workouts.',
    'עדכן את שאלון הבריאות אם התשובות השתנו או הוזנו בטעות':'Update your health answers if they changed or were entered by mistake',
    'המשך':'Continue',
    'חזרה':'Back',
